...
const CalendarScreen = () => {
  ...
  const fetchWorkerAvailability = async (id) => {
    try {
      const response = await fetch(`https://quackapp-backend-mprx.onrender.com/api/workers/${id}/availability-status`, {
        method: 'GET',
        credentials: 'include',
      });
  ...
  const handleAvailability = async () => {
    ...
    try {
      const response = await fetch(`https://quackapp-backend-mprx.onrender.com/api/workers/${workerId}/availability`, {
        method: 'PUT',
        headers: {
