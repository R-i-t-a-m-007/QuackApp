...
const ForgotCompanyPasswordScreen = () => {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      const response = await fetch('https://quackapp-backend-mprx.onrender.com/api/companies/forgot-password', {
        method: 'POST',
        headers: {
...
export default ForgotCompanyPasswordScreen;
