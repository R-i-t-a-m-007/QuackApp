    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        if (res.ok) {
          ...
          fetchWorkerInfo(); // Refresh worker info to get the updated image
        } else {
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <LinearGradient colors={['#f3ae0a', '#f3ae0a', '#f3830a']} style={styles.navbar}>
            ...
            <Text style={styles.navTitle}>Worker Account</Text>
            ...
            {loading ? (
              ...
              <View style={styles.contentContainer}>
                <View style={styles.profileSection}>
                  ...
                  <Text style={styles.welcome}>Welcome to your worker profile</Text>
                </View>
                <View style={styles.detailsSection}>
                  <DetailCard label="Name" value={workerDetails.name || 'N/A'} icon="person" />
