    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await fetch('https://quackapp-backend.onrender.com/api/companies/logout', {
                method: 'POST',
                credentials: 'include',
              });
  ...
  const uploadImage = async (uri) => {
    try {
      ...
      reader.onloadend = async () => {
        ...
        const res = await fetch(`https://quackapp-backend.onrender.com/api/companies/${companyDetails._id}/upload-image`, {
          method: 'POST',
          headers: {
